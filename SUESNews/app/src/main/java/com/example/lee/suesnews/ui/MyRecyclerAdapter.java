...
//    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        SimpleDraweeView titleImageView = (SimpleDraweeView) v.findViewById(R.id.titleImageView);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private SimpleDraweeView mTitleImageView;
        ...
        public ViewHolder(View v,TextView titleTextView,TextView dateTextView,SimpleDraweeView imageView){
            this(v);
        ...
        public void bindData(NewsItem newsItem){
            ...
            //图片随机分配
            mTitleImageView.setImageURI(Uri.parse(newsItem.getNewsImg()));
            mNewsItem = newsItem;
        }
