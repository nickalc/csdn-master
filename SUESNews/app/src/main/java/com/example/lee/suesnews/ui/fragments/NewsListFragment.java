...
import com.example.lee.suesnews.ui.BlogDetailActivity;
    ...
    private void init(View view) {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(),new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent startActivityIntent = new Intent(getActivity(),BlogDetailActivity.class);
...
//                }
        ...
        protected void onPostExecute(List<NewsItem> newsItems) {
            if (newsItems == null) {
              //  Toast.makeText(getActivity(), getActivity().getResources().getString(R.string.net_unavaiable), Toast.LENGTH_LONG).show();
                return;
            }
            //处理强制刷新
            if(mIsForced){
